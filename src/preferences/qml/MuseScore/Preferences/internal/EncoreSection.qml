...
BaseSection {
    ...
    ComboBoxWithTitle {
        ...
        navigation.name: "EncoreInstrumentSearchModeBox"
        navigation.panel: root.navigation
        navigation.row: 0
    ...
    Column {
        ...
        ComboBoxWithTitle {
            ...
            navigation.name: "EncoreUnderfillStrategyBox"
            navigation.panel: root.navigation
            navigation.row: 8
        ...
        ComboBoxWithTitle {
            ...
            navigation.name: "EncoreOverfillStrategyBox"
            navigation.panel: root.navigation
            navigation.row: 9
        ...
        ComboBoxWithTitle {
            ...
            navigation.name: "EncoreTablatureImportModeBox"
            navigation.panel: root.navigation
            navigation.row: 11
