...
void buildNoteLoop(BuildCtx& ctx)
{
    ...
    for (MeasureBase* mb = score->first(); mb; mb = mb->next()) {
        ...
        case EncElemType::NOTE:      handleNote();      break;
        case EncElemType::REST:      handleRest();      break;
        case EncElemType::CHORD:     handleChordSym();  break;
        case EncElemType::LYRIC:     handleLyric();     break;
        case EncElemType::ORNAMENT:  handleOrnament();  break;
        case EncElemType::KEYCHANGE: handleKeyChange(); break;
        default: break;
        }
